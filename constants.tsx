...
import { Student, Exercise, WorkoutType } from './types';

export const MOCK_STUDENTS: Student[] = [
  { id: 's1', name: 'João Silva', email: 'joao@email.com', password: '123', level: 'Intermediate', paymentDueDate: '2025-05-15', status: 'active', isVerified: true, paymentHistory: [], planValue: 150 }
];

export const MOCK_EXERCISES: Exercise[] = [
  { id: 'ex1', title: 'Mobilidade', description: 'Ativação inicial.', videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', category: WorkoutType.ACTIVATION }
];
...
export const Icons = {
  ...
  Strength: () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.048 8.287 8.287 0 0 0 9 9.6a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z" /></svg>,
